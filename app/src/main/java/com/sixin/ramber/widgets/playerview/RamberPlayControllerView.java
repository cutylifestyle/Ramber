package com.sixin.ramber.widgets.playerview;
...
public class RamberPlayControllerView extends FrameLayout {
    ...
    private static final class DefaultControlDispatcher
            extends com.google.android.exoplayer2.DefaultControlDispatcher implements RamberPlayControllerView.ControlDispatcher {}
    /**
     * @deprecated Use {@link com.google.android.exoplayer2.DefaultControlDispatcher}.
     */
    @Deprecated
    public static final RamberPlayControllerView.ControlDispatcher DEFAULT_CONTROL_DISPATCHER = new RamberPlayControllerView.DefaultControlDispatcher();
    ...
    private final RamberPlayControllerView.ComponentListener componentListener;
    ...
    private RamberPlayControllerView.VisibilityListener visibilityListener;
    ...
    private Drawable selectShuffleButtonDrawable;
    private Drawable unSelectShuffleButtonDrawable;
    ...
    public RamberPlayControllerView(Context context) {
        this(context, null);
    }

    public RamberPlayControllerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RamberPlayControllerView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public RamberPlayControllerView(Context context, AttributeSet attrs, int defStyleAttr,
        ...
        componentListener = new RamberPlayControllerView.ComponentListener();
        ...
        shuffleButton = (ImageView) findViewById(R.id.exo_shuffle);
        if (shuffleButton != null) {
            shuffleButton.setOnClickListener(componentListener);
        }
        Resources resources = context.getResources();
        repeatOffButtonDrawable = resources.getDrawable(R.drawable.ic_repeat_none);
        repeatOneButtonDrawable = resources.getDrawable(R.drawable.ic_repeat_one);
        repeatAllButtonDrawable = resources.getDrawable(R.drawable.ic_repeat_all);
        ...
        selectShuffleButtonDrawable = resources.getDrawable(R.drawable.ic_shuffle_selected);
        unSelectShuffleButtonDrawable = resources.getDrawable(R.drawable.ic_shuffle_unselected);
    }
     ...
     */
    public void setVisibilityListener(RamberPlayControllerView.VisibilityListener listener) {
...
//            shuffleButton.setAlpha(player.getShuffleModeEnabled() ? 1f : 0.3f);
            shuffleButton.setImageDrawable(player.getShuffleModeEnabled()?selectShuffleButtonDrawable:unSelectShuffleButtonDrawable);
