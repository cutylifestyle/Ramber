...
public class RamberPlayerView extends FrameLayout {
    ...
    private final RamberPlayControllerView controller;
    private final RamberPlayerView.ComponentListener componentListener;
    ...
    public RamberPlayerView(Context context) {
        this(context, null);
    }

    public RamberPlayerView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RamberPlayerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int controllerShowTimeoutMs = RamberPlayControllerView.DEFAULT_SHOW_TIMEOUT_MS;
        ...
        componentListener = new RamberPlayerView.ComponentListener();
        ...
        RamberPlayControllerView customController = (RamberPlayControllerView) findViewById(com.google.android.exoplayer2.ui.R.id.exo_controller);
        ...
        if (customController != null) {
            ...
            this.controller = new RamberPlayControllerView(context, null, 0, attrs);
     ...
     */
    public void setControllerVisibilityListener(RamberPlayControllerView.VisibilityListener listener) {
        Assertions.checkState(controller != null);
